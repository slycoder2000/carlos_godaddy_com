...
function AddToStorage(field) {
	...
	localStorage.setItem('pos' + field, f1);
	localStorage.setItem('desc' + field, f2);
	localStorage.setItem('amt' + field, f3);
	localStorage.setItem('calc' + field, f4);
}
...
function ReadStorageFields(field) {
	//let itemsArray = localStorage.getItem('items') ? JSON.parse(localStorage.getItem('items')) : [];
	if (localStorage.getItem('pos' + field)) {
		let f1 = localStorage.getItem('pos' + field);
		if (f1 == 'true') {
	...
	if (localStorage.getItem('desc' + field)) {
		document.getElementById('desc' + field).value = localStorage.getItem('desc' + field);
	}
	if (localStorage.getItem('amt' + field)) {
		document.getElementById('amt' + field).value = localStorage.getItem('amt' + field);
	}

	if (localStorage.getItem('calc' + field)) {
		let f4 = localStorage.getItem('calc' + field);
		if (f4 == 'true') {
